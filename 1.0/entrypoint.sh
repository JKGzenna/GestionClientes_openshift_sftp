#!/bin/bash
## SETUP HOST KEYS ALWAYS WITH SAME RSA KEYS PROVIDED IN DOCKERFILE WITH 'authorized_keys'
...
## Always generate new host keys for replace before then with 'authorized_keys'
ssh-keygen -A && \
...
## Replace the new generated host keys with keys of 'authorized_keys' folder and fix permissions
